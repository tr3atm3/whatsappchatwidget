(function () {
  function CreateWhatsAppButtonAndWidget(config) {
    ...
    const createButton = () => {
      ...
      button.style.padding = isOpen ? "10px 10px 8px" : "8px 15px";
...
`;
    ...
    const createPopup = () => {
      ...
      const svgPoweredBy = `<svg fill="#B8860B" height="12px" width="13px" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
